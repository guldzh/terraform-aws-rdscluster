...
resource "aws_rds_cluster" "rds-cluster" {
  ...
  availability_zones        = ["us-east-1#", "us-east-1#", "us-east-1#"] #Update the AZs accordingly
  engine                    = "aurora-mysql"
...
resource "aws_rds_cluster_instance" "rds-writer" {
...
resource "aws_rds_cluster_endpoint" "eligible" {
  ...
  excluded_members = [
    aws_rds_cluster_instance.rds-writer.id,
